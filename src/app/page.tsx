    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <Container className="relative py-24 sm:py-32">
          ...
          <h1 className="balance mt-5 max-w-2xl text-4xl font-semibold leading-[1.05] text-white sm:text-6xl">
            <HeroWords text={t.home.heroTitle} />
          </h1>
          <HeroFade delay={0.9}>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-white/75 sm:text-lg">{t.home.heroSubtitle}</p>
          </HeroFade>
          <HeroFade delay={1.2} className="mt-9 flex flex-wrap items-center gap-4">
        ...
        <Container className="py-12">
          ...
          <Stagger className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {featuredTimes.map((item, idx) => (
              <StaggerItem key={idx} className="rounded-2xl border border-ink/8 bg-white p-5">
      ...
      <section className="py-20 sm:py-28">
        <Container className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <Reveal delay={0.15} className="relative flex items-center justify-center rounded-3xl bg-cream p-10">
        ...
        <Container className="relative">
          ...
          <Stagger className="mt-10 grid gap-4 sm:grid-cols-3">
            {t.home.missionPillars.map((pillar, idx) => (
              <StaggerItem key={idx} className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
